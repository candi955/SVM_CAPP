...
tab_control.add(tab1, text='Attack Target Prediction')
...
DummyOneButtonSubmit = Button(tab1, text="Submit Attack Origin", command=lambda: get_selDummyOne(), width=20, bg='purple', fg='#fff')
